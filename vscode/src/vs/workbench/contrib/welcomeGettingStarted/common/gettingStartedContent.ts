...
export const startEntries: GettingStartedStartEntryContent = [
	{
		id: 'topLevelSkyChat',
		title: localize('gettingStarted.skyChat.title', "Open Sky Chat"),
		description: localize('gettingStarted.skyChat.description', "Chat with Sky AI to generate code, automate tasks, and more"),
		icon: Codicon.chatSparkle,
		when: '!isWeb',
		content: {
			type: 'startEntry',
			command: 'command:sky-ai.openChat',
		}
	},
	{
	...
	{
		id: 'topLevelSkyMarketplace',
		title: localize('gettingStarted.skyMarketplace.title', "Sky Marketplace"),
		description: localize('gettingStarted.skyMarketplace.description', "Discover and install AI skills for Sky"),
		icon: Codicon.extensions,
		when: '!isWeb',
		content: {
			type: 'startEntry',
			command: 'command:sky-ai.openMarketplace',
		}
	},
];
...
// Copilot setup steps removed — Sky AI provides its own chat experience
